...
int main(int argc, char const *argv[])
{
    ...
    cout<<"layer conv2d_2 first weight:"<<l_conv2d_6.weight[0]<<endl;
    cout<<"layer conv2d_2 first bias:"<<l_conv2d_6.bias[0]<<endl;
    ...
    Size OShape(l_maxp2d_2.im_w,l_maxp2d_2.im_h);   //output shape
    ...
    for (int layer = 0; layer < 64; ++layer)
    {
        ...
        {
            output2[i]=output_conv2d_6[i+ALen*layer];
        }
        cout<<"*****************************************"<<endl;
        cout<<"layer:"<<layer<<endl;
        cout<<"*****************************************"<<endl;
        cv::Mat output_img(OShape.width,OShape.height,CV_32F,output2);
        cout<<output_img.rowRange(0,5).colRange(0,5)<<endl;
    }
