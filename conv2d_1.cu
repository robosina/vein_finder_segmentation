...
#if using_cudnn==1
//********conv2d_1******************************
cudnnTensorDescriptor_t input_descriptor_1;
...
extern "C" void conv2d_1(float* img_ptr,int w,int h,layer l)
{
    ...
    checkCUDNN(cudnnConvolutionForward(cudnn_1,
                                       &alpha,
                                       input_descriptor_1,
                                       d_input,
                                       kernel_descriptor_1,
    ...
    add_bias<<<grid,block>>>(d_output,d_bias,256,256,16);
#if print==1
    printf("time elapsed \033[1;35mconv2d_1:%f msec\n\033[0m",1000*(GetTime()-t1));
#endif
#else
    time_sum=0;
...
extern "C" void LOAD_NEURAL_NETWORK(LAYER Layer, int w, int h, layer& l)
{
    ...
    case CONV2D_1:
    {
        ...
        checkCUDNN(cudnnCreateTensorDescriptor(&input_descriptor_1));
        checkCUDNN(cudnnSetTensor4dDescriptor(input_descriptor_1,
        ...
        checkCUDNN(cudnnCreateTensorDescriptor(&output_descriptor_1));
        checkCUDNN(cudnnSetTensor4dDescriptor(output_descriptor_1,
                                              /*format=*/CUDNN_TENSOR_NCHW,
                                              /*dataType=*/CUDNN_DATA_FLOAT,
                                              /*batch_size=*/1,
                                              /*channels=*/16,
        ...
        checkCUDNN(cudnnCreateFilterDescriptor(&kernel_descriptor_1));
        checkCUDNN(cudnnSetFilter4dDescriptor(kernel_descriptor_1,
                                              /*dataType=*/CUDNN_DATA_FLOAT,
                                              /*format=*/CUDNN_TENSOR_NCHW,
                                              /*out_channels=*/16,
                                              /*in_channels=*/1,
        ...
        checkCUDNN(cudnnSetConvolution2dDescriptor(convolution_descriptor_1,
                                                   /*pad_height=*/1,
                                                   /*pad_width=*/1,
                                                   /*vertical_stride=*/1,
                                                   /*horizontal_stride=*/1,
        ...
        checkCUDNN(
            cudnnGetConvolutionForwardAlgorithm(cudnn_1,
                                                input_descriptor_1,
                                                kernel_descriptor_1,
                                                convolution_descriptor_1,
                                                output_descriptor_1,
        ...
        checkCUDNN(cudnnGetConvolutionForwardWorkspaceSize(cudnn_1,
                                                           input_descriptor_1,
                                                           kernel_descriptor_1,
                                                           convolution_descriptor_1,
                                                           output_descriptor_1,
...
extern "C" void Remove_NN()
{
    ...
    cudaFree(d_workspace_4);
    cudaFree(d_workspace_5);
    cudaFree(d_workspace_6);
    cudaFree(d_workspace_7);
    cudaFree(d_workspace_8);
    cudaFree(d_workspace_9);
    cudaFree(d_workspace_10);
    cudaFree(d_workspace_11);
    cudaFree(d_workspace_12);
    cudaFree(d_workspace_13);
    cudaFree(d_workspace_14);
    cudaFree(d_workspace_15);
    cudaFree(d_workspace_16);
    cudaFree(d_workspace_17);
    cudaFree(d_workspace_18);
    cudaFree(d_workspace_19);
    cudaFree(d_workspace_20);
    cudaFree(d_workspace_21);
    cudaFree(d_workspace_22);
    cudaFree(d_workspace_23);

    cudnnDestroyTensorDescriptor(input_descriptor_1);
    ...
    cudnnDestroy(cudnn_1);
    cudnnDestroyTensorDescriptor(input_descriptor_2);
    cudnnDestroyTensorDescriptor(output_descriptor_2);
    cudnnDestroyFilterDescriptor(kernel_descriptor_2);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_2);
    cudnnDestroy(cudnn_2);
    cudnnDestroyTensorDescriptor(input_descriptor_3);
    cudnnDestroyTensorDescriptor(output_descriptor_3);
    cudnnDestroyFilterDescriptor(kernel_descriptor_3);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_3);
    cudnnDestroy(cudnn_3);
    cudnnDestroyTensorDescriptor(input_descriptor_4);
    cudnnDestroyTensorDescriptor(output_descriptor_4);
    cudnnDestroyFilterDescriptor(kernel_descriptor_4);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_4);
    cudnnDestroy(cudnn_4);
    cudnnDestroyTensorDescriptor(input_descriptor_5);
    cudnnDestroyTensorDescriptor(output_descriptor_5);
    cudnnDestroyFilterDescriptor(kernel_descriptor_5);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_5);
    cudnnDestroy(cudnn_5);
    cudnnDestroyTensorDescriptor(input_descriptor_6);
    cudnnDestroyTensorDescriptor(output_descriptor_6);
    cudnnDestroyFilterDescriptor(kernel_descriptor_6);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_6);
    cudnnDestroy(cudnn_6);
    cudnnDestroyTensorDescriptor(input_descriptor_7);
    cudnnDestroyTensorDescriptor(output_descriptor_7);
    cudnnDestroyFilterDescriptor(kernel_descriptor_7);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_7);
    cudnnDestroy(cudnn_7);
    cudnnDestroyTensorDescriptor(input_descriptor_8);
    cudnnDestroyTensorDescriptor(output_descriptor_8);
    cudnnDestroyFilterDescriptor(kernel_descriptor_8);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_8);
    cudnnDestroy(cudnn_8);
    cudnnDestroyTensorDescriptor(input_descriptor_9);
    cudnnDestroyTensorDescriptor(output_descriptor_9);
    cudnnDestroyFilterDescriptor(kernel_descriptor_9);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_9);
    cudnnDestroy(cudnn_9);
    cudnnDestroyTensorDescriptor(input_descriptor_10);
    cudnnDestroyTensorDescriptor(output_descriptor_10);
    cudnnDestroyFilterDescriptor(kernel_descriptor_10);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_10);
    cudnnDestroy(cudnn_10);
    cudnnDestroyTensorDescriptor(input_descriptor_11);
    cudnnDestroyTensorDescriptor(output_descriptor_11);
    cudnnDestroyFilterDescriptor(kernel_descriptor_11);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_11);
    cudnnDestroy(cudnn_11);
    cudnnDestroyTensorDescriptor(input_descriptor_12);
    cudnnDestroyTensorDescriptor(output_descriptor_12);
    cudnnDestroyFilterDescriptor(kernel_descriptor_12);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_12);
    cudnnDestroy(cudnn_12);
    cudnnDestroyTensorDescriptor(input_descriptor_13);
    cudnnDestroyTensorDescriptor(output_descriptor_13);
    cudnnDestroyFilterDescriptor(kernel_descriptor_13);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_13);
    cudnnDestroy(cudnn_13);
    cudnnDestroyTensorDescriptor(input_descriptor_14);
    cudnnDestroyTensorDescriptor(output_descriptor_14);
    cudnnDestroyFilterDescriptor(kernel_descriptor_14);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_14);
    cudnnDestroy(cudnn_14);
    cudnnDestroyTensorDescriptor(input_descriptor_15);
    cudnnDestroyTensorDescriptor(output_descriptor_15);
    cudnnDestroyFilterDescriptor(kernel_descriptor_15);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_15);
    cudnnDestroy(cudnn_15);
    cudnnDestroyTensorDescriptor(input_descriptor_16);
    cudnnDestroyTensorDescriptor(output_descriptor_16);
    cudnnDestroyFilterDescriptor(kernel_descriptor_16);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_16);
    cudnnDestroy(cudnn_16);
    cudnnDestroyTensorDescriptor(input_descriptor_17);
    cudnnDestroyTensorDescriptor(output_descriptor_17);
    cudnnDestroyFilterDescriptor(kernel_descriptor_17);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_17);
    cudnnDestroy(cudnn_17);
    cudnnDestroyTensorDescriptor(input_descriptor_18);
    cudnnDestroyTensorDescriptor(output_descriptor_18);
    cudnnDestroyFilterDescriptor(kernel_descriptor_18);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_18);
    cudnnDestroy(cudnn_18);
    cudnnDestroyTensorDescriptor(input_descriptor_19);
    cudnnDestroyTensorDescriptor(output_descriptor_19);
    cudnnDestroyFilterDescriptor(kernel_descriptor_19);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_19);
    cudnnDestroy(cudnn_19);
    cudnnDestroyTensorDescriptor(input_descriptor_20);
    cudnnDestroyTensorDescriptor(output_descriptor_20);
    cudnnDestroyFilterDescriptor(kernel_descriptor_20);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_20);
    cudnnDestroy(cudnn_20);
    cudnnDestroyTensorDescriptor(input_descriptor_21);
    cudnnDestroyTensorDescriptor(output_descriptor_21);
    cudnnDestroyFilterDescriptor(kernel_descriptor_21);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_21);
    cudnnDestroy(cudnn_21);
    cudnnDestroyTensorDescriptor(input_descriptor_22);
    cudnnDestroyTensorDescriptor(output_descriptor_22);
    cudnnDestroyFilterDescriptor(kernel_descriptor_22);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_22);
    cudnnDestroy(cudnn_22);
    cudnnDestroyTensorDescriptor(input_descriptor_23);
    cudnnDestroyTensorDescriptor(output_descriptor_23);
    cudnnDestroyFilterDescriptor(kernel_descriptor_23);
    cudnnDestroyConvolutionDescriptor(convolution_descriptor_23);
    cudnnDestroy(cudnn_23);
